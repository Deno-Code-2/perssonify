...
import { ArrowRight, Target, CheckCircle, Zap } from 'lucide-react';
...
const CrossFunctionalLeadership: React.FC = () => {
  ...
  const useCases = [
    'Org-wide initiative execution',
    'Post-merger integration',
    'Process reengineering across silos',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <section className="py-16">
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-3xl font-bold text-foreground mb-8">How We Empower Cross-Functional Leadership</h2>
